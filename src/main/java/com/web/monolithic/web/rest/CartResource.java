...
/**
 * REST controller for managing {@link com.web.monolithic.domain.Cart}.
 */
@RestController
@RequestMapping("/api")
public class CartResource {
    ...
    /**
     * {@code SEARCH  /_search/carts?query=:query} : search for the cart corresponding
     * to the query.
     *
    ...
    public ResponseEntity<List<CartDTO>> searchCarts(
