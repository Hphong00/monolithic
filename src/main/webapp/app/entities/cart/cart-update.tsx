  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="webApp.cart.home.createOrEditLabel" data-cy="CartCreateUpdateHeading">
            <Translate contentKey="webApp.cart.home.createOrEditLabel">Create or edit a Cart</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              {!isNew ? (
                <ValidatedField
                  ...
                  readOnly
                  id="cart-id"
                  label={translate('webApp.cart.id')}
                  validate={{ required: true }}
                />
              ) : null}
              <ValidatedField label={translate('webApp.cart.userId')} id="cart-userId" name="userId" data-cy="userId" type="text" />
              <ValidatedField
                label={translate('webApp.cart.createdAt')}
                id="cart-createdAt"
                name="createdAt"
                data-cy="createdAt"
                type="datetime-local"
              ...
              />
              <ValidatedField
                label={translate('webApp.cart.updatedAt')}
                id="cart-updatedAt"
                name="updatedAt"
                data-cy="updatedAt"
                type="datetime-local"
