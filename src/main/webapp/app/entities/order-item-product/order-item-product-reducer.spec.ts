...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './order-item-product.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ORDERITEMPRODUCT_LIST actions', async () => {
    ...
    it('dispatches SEARCH_ORDERITEMPRODUCTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_ORDERITEMPRODUCT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ORDERITEMPRODUCT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ORDERITEMPRODUCT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ORDERITEMPRODUCT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ORDERITEMPRODUCT actions', async () => {
      const expectedActions = [
        {
